...
abstract class $NoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int lessonId, String text, Date date});
...
class _$NoteImpl with DiagnosticableTreeMixin implements _Note {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Note(id: $id, lessonId: $lessonId, text: $text, date: $date)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, lessonId, text, date);
...
abstract class _Note implements Note {
  const factory _Note(
      ...
      required final Date date}) = _$NoteImpl;
